...
//======WEST TEAM======
robot EDU.gatech.cc.is.abstractrobot.SocSmallSim deme_leblond_strategie.Demeleblond
//------------your control system name goes here ^^^^^^^^
	-1.2  0    0 x1E88E5 xFFFFFF 1
robot EDU.gatech.cc.is.abstractrobot.SocSmallSim deme_leblond_strategie.Demeleblond
//------------your control system name goes here ^^^^^^^^
	-.5   0    0 x1E88E5 xFFFFFF 1
robot EDU.gatech.cc.is.abstractrobot.SocSmallSim deme_leblond_strategie.Demeleblond
//------------your control system name goes here ^^^^^^^^
	-.15  .5   0 x1E88E5 xFFFFFF 1
robot EDU.gatech.cc.is.abstractrobot.SocSmallSim deme_leblond_strategie.Demeleblond
//------------your control system name goes here ^^^^^^^^
	-.15  0    0 x1E88E5 xFFFFFF 1
robot EDU.gatech.cc.is.abstractrobot.SocSmallSim deme_leblond_strategie.Demeleblond
//------------your control system name goes here ^^^^^^^^
	-.15  -.5  0 x1E88E5 xFFFFFF 1
...
robot EDU.gatech.cc.is.abstractrobot.SocSmallSim BasicTeam
	 1.2  0    0 xF57C00 xFFFFFF 2
robot EDU.gatech.cc.is.abstractrobot.SocSmallSim BasicTeam
	 .5   0    0 xF57C00 xFFFFFF 2
robot EDU.gatech.cc.is.abstractrobot.SocSmallSim BasicTeam
	 .15  .5   0 xF57C00 xFFFFFF 2
robot EDU.gatech.cc.is.abstractrobot.SocSmallSim BasicTeam
	 .15  0    0 xF57C00 xFFFFFF 2
robot EDU.gatech.cc.is.abstractrobot.SocSmallSim BasicTeam
	 .15  -.5  0 xF57C00 xFFFFFF 2
